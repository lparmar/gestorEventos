...
<div class="p-4 sm:ml-64">
    <div class="mx-auto justify-center items-center grid gap-6 m-3">
        ...
        <div class="p-4 sm:p-8 mb-20 bg-white shadow sm:rounded-lg mt-6">
            <div>
            ...
            <div class="mx-auto">
                    ...
                    <div
                        ...
                        <figure
                            ...
                            <figcaption class="flex items-center justify-center space-x-3">
                                ...
                                <div class="space-y-0.5 font-medium dark:text-white text-left">
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ $activity->activityType->name }}</div>
                                </div>
                            </figcaption>
                        </figure>
                        <figure
                ...
                @if (count($media) > '0')
                    ...
                    <div class="flex items-center justify-center mb-8">
                        <div
                            class="w-full max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                @foreach ($media as $document)
                                    <li>
                                        <a href="{{ $document->original_url }}" target="_blank"
                                            ...
                                            @endif
                                            <span
                                                class="flex-1 ml-3 whitespace-nowrap">{{ $document->file_name }}</span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
