...
<div class="p-4 sm:ml-64">
    ...
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <form id="formUpdate" method="POST" action="{{ route('users.update', $userProfile) }}"
            ...
            @method('patch')
            <div
                class="max-w-md m-auto p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="flex flex-col items-center pb-10">
                    ...
                    @endif
                    <h5 class="mb-1 mt-3 text-xl font-light dark:text-white">Correo electrónico:
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg mt-6">
                ...
                <div class="mx-auto">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="surname_first" name="surname_first"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $userProfile->surname_first }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="dni" name="dni"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $userProfile->dni }}" required>
                        </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit"
                            class="text-white bg-[#2557D6] hover:bg-[#2557D6]/90 focus:ring-4 focus:ring-[#2557D6]/50 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 mr-2">Guardar</button>
                    </div>
        </form>
    </div>
</div>
